...
public class NmwEmailLegacyTldInitializer extends TagReferenceInitializer {
	...
	public NmwEmailLegacyTldInitializer() {
		super(
			...
			// Self
			"com.newmediaworks.taglib.email", Maven.properties.getProperty("project.url") + "apidocs/",
			"com.newmediaworks.taglib.email.legacy", Maven.properties.getProperty("project.url") + "apidocs/"
		);
	}
}
